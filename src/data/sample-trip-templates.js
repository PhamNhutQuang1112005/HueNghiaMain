...
const DEFAULT_SGCD_TRIPS = [
  ...
  { id: '2', name: 'Sài Gòn - An Giang - Chạy bến An Sương', time: '08:30', route: 'Sài Gòn - An Giang', plate: '50H-678.90', vehicleType: 'Giường nằm 34 chỗ', date: todayStr__constants, price: 250000, status: 'Đã chỉ định xe', note: 'Chạy bến An Sương - Đón dọc QL22' },
  { id: '3', name: 'Sài Gòn - An Giang - Chuyến sáng trung tâm', time: '10:00', route: 'Sài Gòn - An Giang', plate: '', vehicleType: 'Limousine 24 Phòng', date: todayStr__constants, price: 280000, status: 'Chưa chỉ định xe', note: 'Chuyến sáng trung tâm - Đã mở bán' },
  { id: '4', name: 'Sài Gòn - An Giang - Tăng cường xe 45 chỗ', time: '13:15', route: 'Sài Gòn - An Giang', plate: '50H-345.67', vehicleType: 'Ghế ngồi 45 chỗ', date: todayStr__constants, price: 180000, status: 'Đã chỉ định xe', note: 'Tăng cường xe 45 chỗ - Rước Kinh Dương Vương' },
  { id: '5', name: 'Sài Gòn - An Giang - Tuyến cố định chiều', time: '15:30', route: 'Sài Gòn - An Giang', plate: '', vehicleType: 'Limousine 24 Phòng', date: todayStr__constants, price: 280000, status: 'Chưa chỉ định xe', note: 'Tuyến cố định chiều - Đón khách VP Q5' },
  { id: '6', name: 'Sài Gòn - An Giang - Chuyến chiều tối', time: '17:00', route: 'Sài Gòn - An Giang', plate: '', vehicleType: 'Giường nằm 34 chỗ', date: todayStr__constants, price: 250000, status: 'Chưa chỉ định xe', note: 'Chuyến chiều tối - Xe giường nằm 34 chỗ' },
];

const DEFAULT_CDSG_TRIPS = [
  { id: '7', name: 'An Giang - Sài Gòn - Xuất bến sớm', time: '06:00', route: 'An Giang - Sài Gòn', plate: '51F-123.45', vehicleType: 'Limousine 24 Phòng', date: todayStr__constants, price: 280000, status: 'Đã chỉ định xe', note: 'Xuất bến sớm - Trả Q.5 & An Sương' },
  { id: '8', name: 'An Giang - Sài Gòn - Chuyến sáng', time: '09:15', route: 'An Giang - Sài Gòn', plate: '50H-678.90', vehicleType: 'Giường nằm 34 chỗ', date: todayStr__constants, price: 250000, status: 'Đã chỉ định xe', note: 'Chuyến sáng - Trung chuyển tận nơi' },
  { id: '9', name: 'An Giang - Sài Gòn - Tuyến cố định rước khách', time: '14:00', route: 'An Giang - Sài Gòn', plate: '', vehicleType: 'Limousine 24 Phòng', date: todayStr__constants, price: 280000, status: 'Chưa chỉ định xe', note: 'Tuyến cố định rước khách dọc đường' },
  { id: '10', name: 'An Giang - Sài Gòn - Chuyến đêm Limousine VIP', time: '21:00', route: 'An Giang - Sài Gòn', plate: '', vehicleType: 'Giường nằm 34 chỗ', date: todayStr__constants, price: 250000, status: 'Chưa chỉ định xe', note: 'Chuyến đêm Limousine VIP - Chạy thẳng Sài Gòn' },
];
